...
abstract class BaseModel
{
    ...
    {
        //1) Get/Compute the number of records that will be generated by the provided query
        $row_count = $this->count($sql, $args);
        //2) Instantiate the PaginationHelper()
        $paginator = new PaginationHelper(
            $this->current_page,
            $this->records_per_page,
            $row_count
        );
        //3) Get the offset from the PaginationHelper's instance
        $offset = $paginator->getOffset();
        //4) Add the following to your query
        // $sql .= LIMIT $offset, $records_per_page
        $sql .= " LIMIT $offset, $this->records_per_page";
        //5) Get Paginated info from the Pagination's instance
        $result = $paginator->getPaginationInfo();
        //5) a) Execute the query and the result to the pagination info.
    ...
    protected function sortingOrder(array $filters): string
    {
